          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            <tr v-for="tag in tags" :key="tag.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gray-100 dark:bg-gray-700/30 text-gray-700 dark:text-gray-400">
                  #{{ tag.tag_name }}
                </span>
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button
                  ...
                  class="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-400 mr-4"
                >
                  수정
                </button>
                <button
